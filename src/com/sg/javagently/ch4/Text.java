...
public class Text {
	...
	/**
	 * Metodo open crea e ritorna un BufferedReader costruito con il file passato
	 * come parametro.
	 * 
	 ...
	 * @throws IOException se la comunicazione del inputStream del bufferedReader si
	 *                     interrompe
	 */
	 ...
	 * @param align  indica il nuero minimo di caratteri che devono essere usati per
	 *               stampare il numero. Se il numero e' 123, e align e' 6,
	 *               nell'output ci saranno 3 spazi prima del numero. Se il numero
	 *               e' 4, e align e' 6, nell'output ci saranno 5 spazi prima del
	 *               numero. Se il numero e' 123, e align e' 3, nell'output ci
	 *               saranno 0 spazi prima del numero.
	 * @return una stringa che rappresenta il numero int formattato con lunghezza
	 ...
	 *               numero. Se il numero e' 123, e align e' 3, nell'output ci
	 *               saranno 0 spazi prima del numero.
	 * @param frac   l'esatto numero di cifre decimali. Se la parte decimale e' piu'
	 *               lunga di frac, tronca il resto. Se la parte decimale e' piu'
	 *               corta di frac, aggiunge zeri finche' si arriva alla lunghezza
	 *               di frac. Se il numero e' intero, si costruisce il suo decimale
	 *               con tanti zeri quanto e' frac.
	 * @return una stringa che rappresenta il numero double formattato con lunghezza
	 *         passata in parametro.
	 */
